...
<div class="match">
    ...
    <svg class="vector-timer" width="573" height="154" viewBox="0 0 573 154" fill="none"
    ...
    <svg class="vector3" width="551" height="301" viewBox="0 0 551 301" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <filter id="filter0_d_116_514" x="0" y="0" width="551" height="309" filterUnits="userSpaceOnUse"
