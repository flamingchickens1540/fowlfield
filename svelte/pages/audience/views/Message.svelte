...
<div class="on-screen-message" out:fade={{}} in:fade={{}}>
    <svg class="rectangle-6" width="1437" height="629" viewBox="0 0 1437 629" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 -19H-19V0V629V648H0H1437H1456V629V0V-19H1437H0Z" fill="#5A5A5A" stroke="url(#paint0_linear_23_63)" stroke-width="38" />
        <defs>
            <linearGradient id="paint0_linear_23_63" x1="-249.23" y1="261.887" x2="1187.77" y2="261.887" gradientUnits="userSpaceOnUse">
